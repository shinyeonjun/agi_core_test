...
DASHBOARD_COMMANDS = (
    MenuCommand("1", "runtime-seed", "시드", "런타임 초기 데이터만 준비"),
    MenuCommand("2", "runtime-auto", "학습", "런타임 데이터로 특징 생성 후 CUDA/CPU 학습"),
    MenuCommand("3", "runtime-cycle", "배포학습", "런타임 학습 후 OrangePi 슬롯에 배포"),
    MenuCommand("4", "compare", "비교", "현재 world 모델과 최고 후보 비교"),
    MenuCommand("5", "deploy-best", "월드배포", "최고 world 모델을 OrangePi에 적용"),
