...
- If self_report_context is present and the user asks about improvement, capability, current status, failures, or learning, treat it as the primary evidence source. Mention recent changes, capability evidence, verification, and limits; do not claim you just read every source file unless the context explicitly says so.
