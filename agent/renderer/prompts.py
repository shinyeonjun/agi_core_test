...
- Never print internal field names such as selected_goal_id, user_goal_created, policy_summary, language_interpretation, renderer, source_event_id, must_include, or must_not_include.
