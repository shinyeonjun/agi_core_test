...
DEFAULT_STATE: dict[str, Any] = {
    "version": "0.15",
    "mode": "idle",
    "current_focus": "agent_core_v0_15_process_table_project_worker",
...
def load_state() -> dict[str, Any]:
    ...
    changed = False
    if merged.get("version") in {"0.1", "0.6", "0.7", "0.8", "0.10", "0.11", "0.12", "0.13", "0.14"}:
        merged["version"] = "0.15"
        changed = True
    if merged.get("current_focus") in {"agent_core_v0_1", "agent_core_v0_6", "agent_core_v0_7_workspace_autonomy", "agent_core_v0_11_operating_intelligence", "agent_core_v0_12_memory_intelligence", "agent_core_v0_13_local_sparse_vectors", "agent_core_v0_14_project_execution_loop"}:
        merged["current_focus"] = "agent_core_v0_15_process_table_project_worker"
        changed = True
    if changed:
        save_state(merged)
    return merged
